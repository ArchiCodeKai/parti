...
export const ARCHITECTS: Architect[] = [
  {
    ...
    relatedIds: [],
    bodyText:
      "瑞士裔法籍建築師、現代主義教父。1923 年發表《邁向建築》、提出「住宅是居住的機器」、奠定現代主義理論基石。發展出自由平面、自由立面、底層架空、屋頂花園、橫向長窗五點原則。早期作品如薩伏伊別墅 (1929) 是純粹主義盛期代表。戰後轉向粗獷主義、馬賽公寓 (1952) 與廊香教堂 (1955) 展示混凝土的塑性美學。",
  },
  {
    ...
    relatedIds: [],
    bodyText:
      "德裔美籍建築師、20 世紀現代主義巨匠。代表名言「Less is more」與「神在細節裡」。1930–1933 年任包浩斯校長。納粹崛起後流亡美國、任 IIT 建築學院院長。代表作 Barcelona Pavilion (1929)、Farnsworth House (1951)、Seagram Building (1958) 定義了國際樣式的純粹幾何美學。",
  },
  {
    ...
    relatedIds: [],
    bodyText:
      "美國建築師、有機建築學派創始人。提出「形式跟隨機能」變奏為「形式與機能合一」。Prairie School 代表、強調水平線條與地景融合。落水山莊 (1935) 是其代表作、懸臂混凝土飄浮於瀑布之上。古根漢美術館 (1959) 螺旋上升的展廳改寫了美術館空間。",
  },
  {
    id: "louis-kahn",
    type: "architect",
    ...
    relatedIds: [],
    bodyText:
      "愛沙尼亞裔美籍建築師、20 世紀紀念碑性現代主義代表。「磚想成為拱」的哲學語錄聞名。Salk Institute (1965) 對稱中庭與廣闊天空形成詩意紀念空間。Kimbell Art Museum (1972) 的雙曲混凝土殼自然光分配是建築史經典。Dhaka 國會大廈 (1983) 為孟加拉留下永恆地標。",
  },
  {
    id: "philip-johnson",
    type: "architect",
